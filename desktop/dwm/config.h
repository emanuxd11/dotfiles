...
#else
static const char *fonts[]               = {"JetBrains Mono:size=11:antialias=true:autohint=true", "Iosevka Nerd Font:size=13:antialias=true:autohint=true"};
...
/* My highlight color */
#define HIGHCOLOR                         "#5496a8"
#define HIGHCOLOR2                        "#c85f5f"
/* The old default one */
#define DEFAULT_HIGHCOLOR                 "#005577"
...
static char titleselfgcolor[]            = "#bbbbbb"; // the foreground color of what I have below
static char titleselbgcolor[]            = "#222222"; // the background color of the application title in the middle when an app is open
static char titleselbordercolor[]        = HIGHCOLOR;
static char titleselfloatcolor[]         = HIGHCOLOR;
...
static char tagsselbgcolor[]             = HIGHCOLOR;
static char tagsselbordercolor[]         = HIGHCOLOR;
static char tagsselfloatcolor[]          = HIGHCOLOR;

static char hidnormfgcolor[]             = HIGHCOLOR;
...
#endif // NAMETAG_PATCH
{
	[DEFAULT_TAGS]        = { "一", "ニ", "三", "四", "五", "六", "七", "八", "九"},
...
static const Layout layouts[] = {
	...
	{ "[Tiling]",      flextile,         { -1, -1, SPLIT_VERTICAL, TOP_TO_BOTTOM, TOP_TO_BOTTOM, 0, NULL } }, // default tile layout
 	{ "[Floating]",      NULL,             {0} },    /* no layout function means floating behavior */
...
static const Key keys[] = {
	...
	/* My own for adjusting brightness and audio */
	/* These only work on the laptop */
    // { 0, XF86XK_MonBrightnessUp, spawn,    {.v = brupcmd} },
    // { 0, XF86XK_MonBrightnessDown, spawn,  {.v = brdowncmd} },
	// { 0, XF86XK_AudioMute, spawn,          {.v = mutecmd} },
	// { 0, XF86XK_AudioLowerVolume, spawn,   {.v = voldowncmd} },
	// { 0, XF86XK_AudioRaiseVolume, spawn,   {.v = volupcmd} },
    /* These are for audio controls on the desktop */
    ...
    /* My own for opening Firefox (profile selection) */
